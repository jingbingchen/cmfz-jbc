...
<head>
    ...
    <script>
        ...
        $.extend($.validator.messages, {
            required: "<span style='color:#c12e2a' >这是必填字段</span>",
                        ...
                        <form role="form" action="${path}/admin/login" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" placeholder="请输入用户名..."
                                       class="form-username form-control" minlength="4" id="name1" required id="form-username">
                            </div>
                            <div class="form-group">
                                <label class="sr-only" for="form-password">Password</label>
                                <input type="password" name="password" placeholder="请输入密码..."
                                       class="form-password form-control" id="password1"  minlength="4" required id="form-password">
                            </div>
                             <div class="form-group">
                                 <label class="sr-only" for="form-code">Code</label>
                                 <img id="captchaImage" style="height: 48px" class="captchaImage" src="${path}/code/code">
                                 <input style="width: 289px;height: 50px;border:3px solid #ddd;border-radius: 4px;" required type="test" name="code1" id="form-code">
                             </div>
